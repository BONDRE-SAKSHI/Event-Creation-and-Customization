      ...
      <div className="py-5 text-white my-5">
        ...
        {events.length === 0 ? (
          <div className="mt-5 pt-5">
            <div className="bg-white text-black p-3 mt-5 h1">
            ...
            {events.map((event) => (
              <div className="accordion-item m-3" key={event.id}>
                <h2 className="accordion-header" id="headingOne">
                  <button
                    className="accordion-button collapsed accordian-back"
                    to=""
                    type="button"
                  ...
                  >
                    ...
                    <h5 className="col-md-2 d-flex justify-content-center align-items-center">
                      {event.status}
                    </h5>
                  ...
                  <div className="accordion-body" id="fordownload">
                    <div className="bg-black py-2 px-2 border border-2 border-white">
                      ...
                      <div className="d-flex justify-content-center">
                        <table className="col-10 table-bordered text-white">
                          <tbody>
                            <tr>
                      ...
                      <div className="d-flex justify-content-center">
                        <table className="col-10 table-bordered text-starttext-white">
                          <tbody>
                            <tr>
                              <td className="bg-white text-black">
                                <h4>Name: </h4>
                            ...
                            <tr>
                              <td>
                                <h4>{event.bookedVenue.name}</h4>
                              </td>
                              <td>
                                <h4>{event.bookedVenue.maxCapacity}</h4>
                              </td>
                              <td>
                                <h4>{event.bookedVenue.category}</h4>
                              </td>
                              <td>
                                <h4>{event.bookedVenue.contact}</h4>
                              </td>
                              <td>
                                <h4>{event.bookedVenue.cost}</h4>
                              </td>
                            </tr>
                            <tr>
                            ...
                            <tr></tr>
                            <tr>
                              <td className="bg-white text-black" colSpan={2}>
                                <h4>Address: </h4>
                              </td>
                              <td className="bg-white text-black" colSpan={3}>
                                <h4>Description: </h4>
                              </td>
                            </tr>
                            <tr>
                              <td colSpan={2}>
                                <h4>{event.bookedVenue.address}</h4>
                              </td>
                              <td colSpan={3}>
                                <h4>{event.bookedVenue.description}</h4>
                              </td>
                            </tr>
                            <tr></tr>
                            <tr></tr>
                            ...
                            <tr>
                              <td>
                                {event.menus.map((menu) => (
                                  <div key={menu.id}>
                                    <h4 className="text-start px-3">
                                      {menu.menuName}{" "}
                                      <span className="text-secondary">
                                        (Price: {menu.price}/person)
                                      </span>
                                    </h4>
                                  </div>
                                ))}
                      ...
                      <div className="d-flex justify-content-center">
                        <table className="col-10 table-bordered text-starttext-white">
                          <tbody>
                            ...
                            <tr>
                              <td>
                                <h4>{event.photography ? "Yes" : "No"}</h4>
                              </td>
                              <td>
                                <h4>{event.videography ? "Yes" : "No"}</h4>
                              </td>
                              <td>
                                <h4>{event.album ? "Yes" : "No"}</h4>
                              </td>
                              <td>
                                <h4>{event.drone ? "Yes" : "No"}</h4>
                              </td>
                              <td>
                                <h4>{event.crane ? "Yes" : "No"}</h4>
                              </td>
                            </tr>
                          </tbody>
                        </table>
                      ...
                      {event.bookedCater ? (
                        <div className="d-flex justify-content-center">
                          <table className="col-10 table-bordered text-starttext-white">
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <h4>{event.bookedCater.name}</h4>
                                </td>
                                <td>
                                  <h4>{event.bookedCater.contactNumber}</h4>
                                </td>
                                <td>
                                  <h4>{event.bookedCater.speciality}</h4>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div className="h3">Please Assign any Cateter</div>
                      )}
                      ...
                      {event.studio ? (
                        <div className="d-flex justify-content-center">
                          <table className="col-10 table-bordered text-starttext-white">
                            <tbody>
                              ...
                              <tr>
                                <td>
                                  <h4>{event.studio.name}</h4>
                                </td>
                                <td>
                                  <h4>{event.studio.contact}</h4>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                        ...
                        <div className="h3">Please Assign any Studio</div>
                      )}
                      {/* 
                      ...
                      <div className="mt-4">
                        <Link
                          className="btn btn-l bg-info text-black mx-1"
                        ...
                        <Link
                          className="btn btn-l bg-info text-black mx-1"
                          to={`/assignemployee/${event.id}`}
                        >
                          assign {forassign}
                        </Link>
                        <Link
                          className="btn btn-l bg-info text-black mx-1 w-25"
                          to={`/viewassignemployee/${event.id}`}
                        >
                          view assigned {forassign}
                        </Link>
                        <Link
                          className="btn btn-l bg-info text-black mx-1"
                          to={`/assigncaters/${event.id}`}
                        >
                          assign Caterers
                        </Link>
                        <Link
                          className="btn btn-l bg-info text-black mx-1"
                          to={`/assignstudio/${event.id}`}
                        >
                          assign Studio
                        </Link>
                      </div>
